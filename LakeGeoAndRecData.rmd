...
###having troubles with these next to models because we don't have integer values

##try the poisson model
poismod1 <- glm(VPY ~ mean_TP + lake_area_ha + meandepth + pcturbancombined_hu12 + mean_secchi + Public.Beach + Public.Park, data = myLakeDF, family = "poisson")
summary(poismod1)

##zip model  
zipmod1 <- zeroinfl(VPY ~ mean_TP + lake_area_ha + meandepth + pcturbancombined_hu12 + mean_secchi + Public.Beach + Public.Park, data = myLakeDF)
summary(zipmod1)
```
