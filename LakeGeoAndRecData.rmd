...
ggmap(wisconsin) + geom_point(data = myLakeDF, aes(x = nhd_long, y = nhd_lat, col = ClusterType, shape = EcoRegion), size = 4) + scale_shape_manual(values = c(15, 16, 17, 18)) + scale_color_manual(values = c("yellow", "blue", "green4")) + scale_x_continuous(limits = c(-93, -87)) + scale_y_continuous(limits = c(42, 47)) + theme(legend.position = c(-89, 47))
```
