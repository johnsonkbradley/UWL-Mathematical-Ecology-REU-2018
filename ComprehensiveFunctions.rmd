...
ggplot(data = twitter2, aes(x = as.factor(floor_date(created_at, unit = "1 week")), y = Sentiment)) +
  theme_bw() +
...
```{r}
ggplot(twitter2, aes(x = DistanceDriven, y = Sentiment)) +
  theme_bw() +
  theme(axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), plot.title = element_text(size = 16)) +
  geom_point(size = 5) +
...
devilsTwitterSimple <- devilsTwitter %>%
                  ...
                  mutate(TotalTweets = c(2,17,17,17,6,6,6,4,4,4), Percent = NumberTweets / TotalTweets)
...
ggplot(data = devilsTwitterLong, aes(x = Week, y = value, fill = SentimentName)) +
  geom_bar(stat = "identity", position = "dodge", col = "black") +
  theme_bw() +
  theme(axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), plot.title = element_text(size = 16)) +
  scale_fill_manual(values = c("green3", "darkgrey", "red"), name = "Sentiment") +
  xlab("Week") +
