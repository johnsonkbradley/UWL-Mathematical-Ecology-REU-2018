...
ggplot(data = craterWeatherMelt) +
  ...
  scale_color_manual(values = c("red", "blue", "cyan", "darkgrey", "white", "black"), name = "Measurement", labels = c(expression("Maximum Temperature " ~degree~ "F"), expression("Minimum Temperature " ~degree~ "F"), "Total Precipitation (inches)", "Total Snowfall (inches)", "Snow Depth (inches)", "Number of Flickr Visitors")) + 
  scale_x_discrete(labels = craterWeather$Month) +
  xlab("Month") +
