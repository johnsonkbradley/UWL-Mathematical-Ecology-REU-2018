...
*We might need to refine how we search for these tweets, either by bounding box or radius method, and then maybe query specific as well depending on the location*
...
mendotaTweets7.6.18 ## 2.6% have a geo-coordinate pair

#save(mendotaTweets7.6.18, file = "medotaTweets7.6.18.rda")
#load("medotaTweets7.6.18.rda")
```
...
craterTweets7.6.18 ## 8% have a geo-coordinate pair

#save(craterTweets7.6.18, file = "craterTweets7.6.18.rda")
#load("craterTweets7.6.18.rda")
```
...
dodgeMonth$Name <- "Governer Dodge State Park, WI"
...
kegonsaMonth$Name <- "Lake Kegonsa State Park, WI"
...
yellowstoneMonth$Name <- "Yellowstone Lake State Park, WI"
...
bigfootMonth$Name <- "Big Foot Beach State Park, WI"
...
mirrorMonth$Name <- "Mirror Lake State Park, WI"
...
penninsulaMonth$Name <- "Penninsula State Park, WI"
```
...
pattisonMonth$Name <- "Pattison State Park, WI"
...
perrotMonth$Name <- "Perrot State Park, WI"
