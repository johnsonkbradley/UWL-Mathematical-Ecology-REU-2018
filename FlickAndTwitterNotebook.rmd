...
ggplot(data = onalaskaVPM, aes(x = EasyDay, y = Count, group = Group)) + geom_line() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggplot(data = onalaskaVPY, aes(x = Year, y = Count, group = Group)) + geom_line()
```
...
ggplot(data = waubesaVPM, aes(x = EasyDay, y = Count, group = Group)) + geom_line() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggplot(data = waubesaVPY, aes(x = Year, y = Count, group = Group)) + geom_line()
```
...
ggplot(data = eaugalleVPM, aes(x = EasyDay, y = Count, group = Group)) + geom_line() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggplot(data = eaugalleVPY, aes(x = Year, y = Count, group = Group)) + geom_line()
```
...
ggplot(data = shawanoVPM, aes(x = EasyDay, y = Count, group = Group)) + geom_line() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggplot(data = shawanoVPY, aes(x = Year, y = Count, group = Group)) + geom_line()
```
...
ggplot(data = druidVPM, aes(x = EasyDay, y = Count, group = Group)) + geom_line() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggplot(data = druidVPY, aes(x = Year, y = Count, group = Group)) + geom_line()
```
