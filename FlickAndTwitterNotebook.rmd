...
ggplot() + geom_line(data = druidVPY, aes(x = Year, y = Count, group = Group), col = "red") + 
  ...
  geom_line(data = visitorsPerYear, aes(x = Year, y = Count, group = Group), col = "yellow") +
  geom_line(data = druidVPY, aes(x = Year, y = Count, group = Group), col = "darkgreen") +
  geom_line(data = hatchVPY, aes(x = Year, y = Count, group = Group), col = "gold") +
  geom_line(data = squashVPY, aes(x = Year, y = Count, group = Group), col = "lightblue") +
  geom_line(data = mcgeeVPY, aes(x = Year, y = Count, group = Group), col = "orange") +
  geom_line(data = towandaVPY, aes(x = Year, y = Count, group = Group), col = "brown") +
  geom_line(data = taborVPY, aes(x = Year, y = Count, group = Group), col = "midnightblue") +
  geom_line(data = willowVPY, aes(x = Year, y = Count, group = Group), col = "black")
```
