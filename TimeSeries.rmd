...
mendotaReport$Year <- substr(mendotaReport$Start.Date, 6, 9)
...
menMonthRep  ## this has so many NaN's so not very usefull at all, total phosphorus has all but 2 entries tho so maybe???
```
...
mononaReport$Year <- substr(mononaReport$Start.Date, 6, 9)
